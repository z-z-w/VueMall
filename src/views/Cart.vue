<template>
    <div>
                            ...
                            <li v-for="item in cartList">
                                ...
                                <div class="cart-tab-5">
                                    <div class="cart-item-opration">
                                        <a href="javascript:;" class="item-edit-btn" @click="delCartModal(item.productId)">
        ...
        <VModal :mdShow="modalConfirm" @closeModal="modalConfirm=false">
            <p slot="message">你确认要删除此商品吗?</p>
            <div slot="btnGroup">
                <a href="javascript:;" class="btn btn--m" @click="delCartConfirm">确认</a>
...
<script>
    ...
    methods: {
      ...
      delCartModal(productId) {
        this.modalConfirm = true;
        this.productId = productId
      },
      delCartConfirm(){
        this.$ajax.post('/users/cartDel', {
      ...
      toggleCheckAll() {
        ...
        this.$ajax.post('/users/editCheckAll', {
          checkAll: flag
        }).then((res) => {
          let data = res.data;
          if(data.status === '0'){
