<template>
    <header class="header">
        ...
        <div class="navbar">
                ...
                <div class="navbar-right-container" style="display: flex;">
                    <div class="navbar-menu-container">
                        ...
                        <a href="javascript:void(0)" class="navbar-link" @click="signUpFlag=true" v-if="!nickName">SignUp</a>
        ...
        <v-modal :mdShow="loginFlag" @closeModal="loginFlag=false">
            ...
            <div class="confirm-tips" slot="message">
                ...
                <ul>
                    ...
                    <li class="regi_form_input noMargin">
                        ...
                        <input v-model="userPwd" type="password" tabindex="2"  name="password" class="regi_login_input regi_login_input_left login-input-no input_text" placeholder="Password" >
                    </li>
                </ul>
            </div>
            <div slot="btnGroup">
        ...
        <v-modal :mdShow="signUpFlag" @closeModal="signUpFlag=false">
            <div class="md-title" slot="title">Sign up</div>
            <div class="confirm-tips" slot="message">
                <div class="error-wrap">
                    <span class="error error-show" v-show="errorTip">{{errorMsg}}</span>
                </div>
                <ul>
                    ...
                    <li class="regi_form_input noMargin">
                        <i class="icon IconPwd"></i>
                        <input v-model="userRePwd" type="password" tabindex="2"  name="RePassword" class="regi_login_input regi_login_input_left login-input-no input_text" placeholder="RePassword" >
                    </li>
                </ul>
            </div>
            <div slot="btnGroup">
    ...
    methods: {
      ...
      getCartCount() {
        this.$ajax.get('/users/cartList').then((res) => {
          let data = res.data;
          this.$store.commit('initCartCount', data.result.length);
        })
      }
    }
  }
